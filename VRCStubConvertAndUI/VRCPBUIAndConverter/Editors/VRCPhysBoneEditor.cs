...
{
  /// <summary>
  /// Custom editor for VRCPhysBone that provides UI and messaging separate from the stub assembly.
  /// </summary>
  ...
  public class VRCPhysBoneEditor : Editor
  {
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var stubVersionLabel = new Label($"Stub Version: {((VRCPhysBone)target).StubVersion}");
      ...
      {
        text = "Remove VRC PhysBone Component"
      };
