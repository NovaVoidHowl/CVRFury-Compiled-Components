...
{
  /// <summary>
  /// Custom editor for VRCAimConstraint that provides UI and CVRFury conversion functionality.
  ...
  public class VRCAimConstraintEditor : Editor
  {
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var stubVersionLabel = new Label($"Stub: {((VRCAimConstraint)target).StubVersion}");
