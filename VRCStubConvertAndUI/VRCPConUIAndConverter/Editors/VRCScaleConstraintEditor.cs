...
{
  /// <summary>
  /// Custom editor for VRCScaleConstraint that provides UI and CVRFury conversion functionality.
  ...
  public class VRCScaleConstraintEditor : Editor
  {
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var stubVersionLabel = new Label($"Stub: {((VRCScaleConstraint)target).StubVersion}");
