...
{
  /// <summary>
  /// Custom editor for VRCLookAtConstraint that provides UI and CVRFury conversion functionality.
  ...
  public class VRCLookAtConstraintEditor : Editor
  {
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var stubVersionLabel = new Label($"Stub: {((VRCLookAtConstraint)target).StubVersion}");
