...
{
  /// <summary>
  /// Custom editor for VRCPositionConstraint that provides UI and CVRFury conversion functionality.
  ...
  public class VRCPositionConstraintEditor : Editor
  {
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var stubVersionLabel = new Label($"Stub: {((VRCPositionConstraint)target).StubVersion}");
